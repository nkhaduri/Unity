...
namespace Complete
{
    ...
    public class TankManager
    {
        ...
        [HideInInspector] public Text namePanel;
        ...
        public void Setup ()
        {
            ...
            m_Movement.namePanel = namePanel;
            ...
            healthT.color = new Color(m_PlayerColor.r, m_PlayerColor.g, m_PlayerColor.b, 1.0f);
            namePanel.text = m_PlayerName;
